<section id="about" style="padding-top: 80px;padding-bottom: 50px;" class="bg-secondary-transparent">
    <div class="card border-0 mx-auto"  style="width: 85%;border-radius: 20px;box-shadow: #1184d076  5px 5px 15px;margin-top: 100px;">
        <div class="card-body">
            ...
            <div class="row d-flex mt-5 justify-content-center" data-aos="fade-right">
                <div class="col-md-6 mb-3">
                    <div style="width: 80%" class="mx-auto">
                        <div class="row d-flex secondary">
